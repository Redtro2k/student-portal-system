<template>
    <div class="bg-indigo-600" v-show="isOpen">
          ...
          <span class="flex p-2 rounded-lg bg-indigo-800">
            <SpeakerphoneIcon class="h-6 w-6 text-white" aria-hidden="true" />
                    ...
                    <p class="ml-3 font-medium text-white truncate">
                        <span class="md:hidden"> {{hiddenMessage}}! </span>
                ...
                <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                    <button type="button" @click.prevent="isOpen = !isOpen" class="-mr-1 flex p-2 rounded-md hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
